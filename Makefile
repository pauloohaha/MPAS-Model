...
ifort-disassembly:
	...
	"CXX_SERIAL = icpc" \
	"FFLAGS_PROMOTION = -real-size 64" \
	"FFLAGS_OPT = -g -O3 -march=cascadelake -convert big_endian -free -align array64byte" \
	"CFLAGS_OPT = -g -O3 -march=cascadelake " \
	"CXXFLAGS_OPT = -g -O3 -march=cascadelake" \
	"LDFLAGS_OPT = -g -O3 -march=cascadelake" \
	"FFLAGS_DEBUG = -g -convert big_endian -free -CU -CB -check all -fpe0 -traceback" \
	"CFLAGS_DEBUG = -g -traceback" \
	"CXXFLAGS_DEBUG = -g -traceback" \
	"LDFLAGS_DEBUG = -g -fpe0 -traceback" \
